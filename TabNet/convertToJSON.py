...
def generateVOC2Json(rootDir,xmlFiles):
  ...
  with open("/content/drive/My Drive/torch/dataset/invitroDataset/converted/coco.json", "w") as f:
    f.write(jsonString)

# Path to the txt file (see at the top of this script)
trainFile = "/content/drive/My Drive/torch/dataset/invitroDataset/coco.txt"
trainXMLFiles = list()
...
rootDir = "/content/drive/My Drive/torch/dataset/invitroDataset/"
